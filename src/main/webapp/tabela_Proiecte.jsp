		...
		<main>
			<div class="table">
				<div class="table_header">
					<form action="cauta_Proiect.jsp" method="post">
		    	...
		    	<div class="overlay_content">
		        	<span class="close" onclick="off('add')">&times;</span>
						        <div class="form_section">
						        	<h1><span>Adăugare Proiect</span></h1>
							        <form action="adauga_Proiect.jsp" method="post">
							            <div class="user_details">
							            	<div class="input_box">
							            		<span class="details">ID:</span>
							            		<input type="text" name="idproiect" placeholder="PJ###" pattern="PJ+[0-9]{3}" required>		
							            	</div>	
							            	<div class="input_box">
							            	...
							            	<div class="input_box">
							            		...
							            		<select name="tip" id="tipuri" required>
							            			<option disabled selected> -- selectează tip -- </option>
							            	...
							            	<div class="input_box">
							            		...
							            		<input type="text" name="descriere" maxlength="45" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Dată finalizare:</span>
							            		<input type="text" name="data_finalizare" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Dată actualizare:</span>
							            		<input type="text" name="data_actualizare" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Versiune:</span>
							            		<input type="text" name="versiune" placeholder="#.#" pattern="[0-9].[0-9]" required>		
							            	</div>	
							            </div>
						        ...
						        <div class="form_section">
							        ...
							        <form action="modifica_Proiect.jsp" method="post" id="modify_form">
							            <div class="user_details">
							            	...
							            	<div class="input_box">
							            		<span class="details">Dată finalizare:</span>
							            		<input class="fill_value" type="text" name="data_finalizare" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Dată actualizare:</span>
							            		<input class="fill_value" type="text" name="data_actualizare" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Versiune:</span>
							            		<input class="fill_value" type="text" placeholder="#.#" pattern="[0-9].[0-9]" name="versiune" required>		
							            	</div>	
							            </div>
							            <div class="submit_button">
