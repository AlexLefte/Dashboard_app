...
<body>
	...
	<div class="main-content">
		...
		<main>
			<%
			String idClient, idProiect, DataAchizitie, Pret, Moneda;
            idClient = request.getParameter("idclient");
            idProiect = request.getParameter("idproiect");
            DataAchizitie = request.getParameter("data_achizitie");
            ...
            if (idClient != null) {
            	...
            	{
	                jb.connect();
	                jb.adaugaAchizitie(java.lang.Integer.parseInt(idClient), idProiect, DataAchizitie, Double.parseDouble(Pret), Moneda);
	                jb.disconnect();
			        %>
			        <div style="padding: 1rem 1rem 1rem 1rem">
			        	<p class="p1" style="font-size: 1.5rem">Datele au fost adăugate cu succes!</p>
			        	<br/>
                ...
                catch(SQLException sqle)
                {
 	        		%>
 		        	<div style="padding: 1rem 1rem 1rem 1rem">
 		        	<p class="p1" style="font-size: 1.5rem">Introducerea datelor a eșuat.</p>
 		        	<br/>
 		        	<a href="tabela_Achizitii.jsp"><button class="button1"><b>Înapoi</b></button></a>
 		        	<br/>
 		        	</div>
        ...
        %>
        <div style="padding: 1rem 1rem 1rem 1rem">
        	<p class="p1" style="font-size: 1.5rem">Introducerea datelor a eșuat. Vă rugăm să încercați din nou!</p>
        	<br/>
        	<a href="tabela_Achizitii.jsp"><button class="button1"><b>Înapoi</b></button></a>
        	<br/>
        </div>
