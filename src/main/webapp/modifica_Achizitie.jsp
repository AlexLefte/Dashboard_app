...
<body>
	...
	<div class="main-content">
		...
		<main>
			<%
			String idachizitie = request.getParameter("idachizitie");
            String idclient = request.getParameter("idclient");
            String idproiect = request.getParameter("idproiect");
            String DataAchizitie = request.getParameter("data_achizitie");
            ...
            if (idclient != null)
            {
            	...
            	{
            	jb.connect();
	            String[] valori = {idclient, idproiect, DataAchizitie, Pret, Moneda};
	            String[] campuri = {"idclient", "idproiect", "data_achizitie", "pret", "moneda"};
	            jb.modificaTabela("achizitii", "idachizitie", idachizitie, campuri, valori);
	            jb.disconnect();
		        %>
            	...
            	catch (SQLException sqle)
            	{
            		%>
		        	<div style="padding: 1rem 1rem 1rem 1rem">
		        	<p class="p1" style="font-size: 1.5rem">Modificarea datelor a eșuat</p>
		        	<br/>
		        	<a href="tabela_Achizitii.jsp"><button class="button1"><b>Înapoi</b></button></a>
		        	<br/>
		        	</div>
