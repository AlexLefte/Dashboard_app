		...
		<main>
			<div class="table">
				<div class="table_header">
					<form action="cauta_Client.jsp" method="post">
					...
					<div class="actions">
						<button id="modifyButton" class="modify" onclick="on('modify')" disabled> Modifică </button>
		    	...
		    	<div class="overlay_content">
		        	<span class="close" onclick="off('add')">&times;</span>
						        <div class="form_section">
						        	<h1><span>Adăugare Client</span></h1>
							        <form action="adauga_Client.jsp" method="post">
							            <div class="user_details">
							            	...
							            	<div class="input_box">
							            		...
							            		<input type="text" name="prenume_reprezentant" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Nume Reprezentant:</span>
							            		<input type="text" name="nume_reprezentant" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Țară:</span>
							            		<input type="text" name="tara" required>		
							            	</div>	
							            	<div class="input_box">
							            		<span class="details">Regiune:</span>
							            		<input type="text" name="regiune" required>		
							            	</div>	
							            	<div class="input_box">
