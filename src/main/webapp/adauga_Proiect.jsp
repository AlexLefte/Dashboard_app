...
<body>
	...
	<div class="main-content">
		...
		<main>
			<%
            String id = request.getParameter("idproiect");
            String nume = request.getParameter("nume");
			String tip = request.getParameter("tip");
			String descriere = request.getParameter("descriere");
			String dataFinalizare = request.getParameter("data_finalizare");
			String dataActualizare = request.getParameter("data_actualizare");
			String versiune = request.getParameter("versiune");
            if (nume != null) {
                try
                {
	            	jb.connect();
	                jb.adaugaProiect(id, nume, tip, descriere, dataFinalizare,
	                		dataActualizare, versiune);
	                jb.disconnect();
			        %>
